      ...
      child: InkWell(
        onDoubleTap: (){
             final snackBar = SnackBar(content:
                 Text("You added this image into your Wishlist "),
        ...
        child: Stack(
          children:[
            Container(
              decoration:BoxDecoration(
                image: DecorationImage(image: AssetImage(widget.imageData.image),fit:BoxFit.cover),
              ),
              child: Container(
                decoration: BoxDecoration(
            ...
            //  Image.asset(widget.imageData.image, fit: BoxFit.cover),
              Column(
         ...
         Row(
           ...
           children:<Widget>[
            ...
            child: Text(" \$ "+'${widget.imageData.price}'+".00",style: TextStyle(fontSize: 18,color: Colors.purple[900]),),
          ),
          IconButton(
            onPressed:null,
